...
#pragma mark --------AppPurchaseToolDelegate--内购代理
/**
 *  内购工具的代理
 */
@protocol AppPurchaseToolDelegate <NSObject>
...
#pragma mark --------AppPurchaseTool--内购工具
/**
 *  内购工具
 */
@interface AppPurchaseTool : NSObject
 ...
 *  代理
 */
@property(nonatomic,strong) id <AppPurchaseToolDelegate> delegate;
