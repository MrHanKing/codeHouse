...
@interface AppPurchaseTool ()<SKPaymentTransactionObserver,SKProductsRequestDelegate>
...
@implementation AppPurchaseTool


//单例
static AppPurchaseTool *storeTool;

//单例
+(AppPurchaseTool *)defaultTool{
    if(!storeTool){
        storeTool = [AppPurchaseTool new];
        [storeTool setup];
    }
    return storeTool;
}
